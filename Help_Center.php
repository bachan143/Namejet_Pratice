        ...
        <!-- Container start -->
           <div class="container">
               ...
               <div class="haeder">
                      ...
                      <div class="help_center"> <!-- Start Help Center -->
                        <div class="row" id="first_help">


                             <div class="col-md-9" >
                                 <h1>Help Center</h1>
                                 <p>NameJet is dedicated to providing you with the answers you need when you need them most. Our Support Center has detailed answers in plain,
                                    easy-to-understand language. Search our FAQs, submit a support ticket or call us today! Service is available Monday through Friday.</p>
                                    <h3><a href="#">Log in to the Support Center</a></h3>


                             </div>
                             <div class="col-md-3" >
                               <span><i class="fas fa-life-ring fa-10x" style="color:#6666ff;"></i></span>
                               <p>Questions? Call sales at</p>
                               <h3>1-866-462-3572</h3>
                          ...
                          <div class="row mt-5" >
                              <div class="col-md-4 pl-5" id="first_col-help">
                                <h3>Tools & Features</h3>
                                <ul>
                                  <li><a href="#">NameJet API</a></li>
                                  <li><a href="#">Browse Domains</a></li>
                                  <li><a href="#">Verified Bidding</a></li>
                                  <li><a href="#">Downloads</a></li>
                                  <li><a href="#">List Your Domains on NameJet</a></li>

                                </ul>

                              </div>
                              <div class="col-md-4">
                                <h3>Aftermarket 101</h3>
                                <ul>
                                  <li><a href="#">Domain Name Services Overview</a></li>
                                  <li><a href="#">Domain Name Aftermarket for Beginners</a></li>
                                  <li><a href="#">Backorder Domain Names</a></li>
                                  <li><a href="#">Advanced Domaining Tools</a></li>
                                  <li><a href="#">Pricing for backordered domains & domain auctions</a></li>
