        ...
        <!-- Container start -->
           <div class="container">
               ...
               <div class="haeder">
                     ...
                     <div class="sitemap ml-5">    <!--Starting Sitemap-->

                               <h1>NameJet Site Map</h1>
                               <h5><a href="#">Browse Domains</a></h5>
                               <ul>
                                   <li><a href="#">Pre-Release Domain Names</a></li>
                                    <li><a href="#">Domains Pending Deletion</a></li>
                                    <li><a href="#">Public Domain Name Auctions</a></li>

                               </ul>
                               <h5><a href="#">Downloads</a></h5>
                               <ul>
                                   <li><a href="#">Download a list of Pre-Release Domains</a></li>
                                    <li><a href="#">Download a list of Pending Delete Domains</a></li>
                                    <li><a href="#">Download a list of Auctions & Listings</a></li>

                               </ul>
                               <h5><a href="#">Aftermarket 101</a></h5>
                               <ul>
                                    ...
                                    <li><a href="#">Terms of Use</a></li>
                                      <li><a href="#">Privacy Policy</a></li>
                                        <li><a href="#">About NameJet</a></li>
                                          <li><a href="#">Contact NameJet</a></li>
